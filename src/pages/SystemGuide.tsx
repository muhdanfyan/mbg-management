...
export const SystemGuide: React.FC = () => {
  ...
  const steps = [
      ...
      content: (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-2xl border border-blue-200">
            <h3 className="text-xl font-bold text-blue-900 mb-4">Pintu Masuk Dana BGN</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100 flex flex-col items-center text-center hover:shadow-md transition-all">
                <div className="bg-orange-100 p-4 rounded-full mb-4">
                  <Building2 className="w-8 h-8 text-orange-600" />
                </div>
                <h4 className="font-bold text-gray-900 text-base">Rp 5.000 (Operasional)</h4>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100 flex flex-col items-center text-center hover:shadow-md transition-all">
                ...
                <h4 className="font-bold text-gray-900 text-base">Rp 10.000 (Bahan Baku)</h4>
          ...
          <div className="bg-white p-4 rounded-2xl border border-gray-200">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="flex-1 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">Validasi Pengeluaran PIC</h3>
              ...
              <div className="flex-1 w-full relative">
                <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden shadow-lg border-4 border-gray-800 relative group">
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
           <div className="bg-white p-4 rounded-2xl border border-gray-200">
            <div className="flex flex-col-reverse md:flex-row gap-4 items-center">
              ...
              <div className="flex-1 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">Perhitungan Margin (Selisih)</h3>
                <p className="text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-[#1A4D43] p-4 rounded-2xl border border-[#1A4D43]/20 shadow-2xl">
            <div className="text-center max-w-2xl mx-auto space-y-4 mb-8">
              <h3 className="text-2xl font-bold text-white">The Central Intelligence</h3>
              <p className="text-[#2BBF9D] font-medium text-base">
                Dashboard ini adalah nyawa dari skema investasi dan transparansi.
              </p>
            </div>
            
            <div className="aspect-[21/9] bg-gray-900 rounded-xl border border-gray-700 overflow-hidden shadow-2xl relative mx-auto max-w-4xl group">
                 ...
                 <div className="absolute inset-0 flex flex-col items-center justify-center p-4 bg-gradient-to-t from-black/80 via-black/40 to-black/80 z-10 text-center">
                    <h4 className="text-white text-lg font-bold mb-2">Simulasi Sewa Skema Investor</h4>
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                       <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-lg text-center min-w-[200px]">
                           <div className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">Investor (60%)</div>
                           <div className="text-xl font-bold text-white">Rp 86,4 Jt</div>
                       </div>
                       <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-lg text-center min-w-[200px]">
                           <div className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">DPP Wahdah (30%)</div>
                           <div className="text-xl font-bold text-[#2BBF9D]">Rp 43,2 Jt</div>
                       </div>
                       <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-lg text-center min-w-[200px]">
                           <div className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">YWMP (10%)</div>
                           <div className="text-xl font-bold text-blue-400">Rp 14,4 Jt</div>
                       </div>
                    </div>
                 </div>
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-white p-4 rounded-2xl border border-gray-200">
            <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <span className="bg-indigo-100 text-indigo-700 p-2 rounded-lg">🎭</span> Skenario Live Demo Terbaik
            </h3>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 text-base">Mulai dari Dashboard Nasional</h4>
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-orange-100 text-orange-700 font-bold flex items-center justify-center shrink-0">2</div>
                <div>
                  <h4 className="font-bold text-gray-900 text-base">Pamerkan Pelaporan Riil (Procurement & Finance)</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 text-base">Galeri Bukti Fisik SPPG</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 text-base">Tutup dengan Modul Investor</h4>
            ...
            <div className="mt-8 p-4 bg-indigo-50 border border-indigo-100 rounded-lg text-indigo-900 text-sm">
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      {/* Header Section */}
      <div className="bg-white rounded-2xl border border-gray-200 p-4 md:p-12 shadow-sm text-center bg-gradient-to-b from-gray-50 to-white">
        <div className="bg-[#1A4D43]/10 w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6">
          <BookOpen className="w-8 h-8 text-[#1A4D43]" />
        </div>
        <h1 className="text-2xl md:text-5xl font-black text-gray-900 tracking-tight mb-4">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex flex-col p-2">
              {steps.map((step) => (
                <button
                  ...
                  className={`flex gap-4 p-4 rounded-xl transition-all duration-300 text-left items-start ${
                    activeStep === step.id 
                ...
                >
                  <div className={`mt-1 shrink-0 p-2 rounded-lg transition-colors ${
        ...
        <div className="w-full lg:w-2/3">
          ...
          <div className="mt-8 flex justify-between items-center bg-white p-4 rounded-xl border border-gray-200 shadow-sm animate-in fade-in">
            <button 
