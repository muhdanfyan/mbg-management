      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-16">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold">Struktur Dana Per Porsi</h2>
          </div>
          
          <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 shadow-sm overflow-hidden relative group">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold">Pendapatan Sewa Dapur</h2>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-3">
                      ...
                      <div className="flex items-end justify-between border-b border-white/10 pb-2">
                         ...
                         <span className="font-bold text-blue-400 text-lg">60% s/d 75%</span>
                      </div>
                   ...
                   <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-3">
                      ...
                      <div className="flex items-end justify-between border-b border-white/10 pb-2">
                         ...
                         <span className="font-bold text-emerald-400 text-lg">Rp 1.600</span>
                      </div>
                      <div className="flex items-end justify-between pt-1">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold">Keuntungan Bahan Baku</h2>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm">
             <div className="p-6 md:p-8 space-y-8">
               ...
               <div className="bg-blue-600 rounded-xl p-6 text-white text-center space-y-4">
